      ...
      <div class="row">
        <div class="login-container col-md-5 px-0 d-flex flex-column justify-content-center align-items-center" style="
          ...
          <h6 style="margin-bottom: 30px; letter-spacing: 2px;">
            <a href="register.php" class="link footer-link">Đăng kí</a>
          </h6>
          <h2 style="
          ...
          <form action="Plogin.php" method="POST">
            ...
            <button type="submit" name="login" class="custom-btn btn-16">Đăng nhập</button>

          </form>
        </div>
        <div class="background-login col-lg-7 px-0">
          <div class="page-header header-filter">
            <div class="page-header-image" style="
									background-image: url('assets/storage/uploads/img/login-img.jpg');
									filter: brightness(75%);
								"></div>
            <div class="content-center">
              <div class="col-md-5 ml-auto text-left" style="margin-bottom: 300px">
                <h4 class="description">
                  “ Mỗi người đều sống 3 cuộc đời: Cuộc
                  đời công khai, riêng tư và bí mật. “
                </h4>
